...
keywords: Azure, javascript, SDK, API, @azure/arm-servicebus, service-bus-messaging
author: jeremymeng
ms.author: yumeng
ms.date: 10/02/2023
ms.topic: reference
...
---
# Azure ServiceBusManagement client library for JavaScript - version 6.2.0-alpha.20231002.1 
